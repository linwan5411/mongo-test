...
/**
 * 用于字符串字符集直接的转换
 * 详见org.apache.commons.codec
 * @author XiaoCanyun
 *
 */
public class StringCodesUtil {
	 /**
    ...
    public static byte[] getBytesUnchecked(final String string, final String charsetName) {
        ...
        try {
        	...
        	throw  returnNewIllegalStateException(charsetName, e);
        }
    ...
    private static IllegalStateException returnNewIllegalStateException(final String charsetName,
