...
public abstract class BaseCodec {
	...
	static class Context {
		...
		/**
		 * Position where next character should be pulish from the buffer.
		 */
		int readPos;
	 ...
	 */
	protected BaseCodec(final int unencodedBlockSize, final int encodedBlockSize, final int lineLength,
	...
	public String encodeToString(final byte[] pArray) {
		return StringCodesUtil.newStringUtf8(encode(pArray));
	}
	...
	public byte[] decode(final String pArray) {
		return decode(StringCodesUtil.getBytesUtf8(pArray));
	}
	...
	public boolean isInAlphabet(final String basen) {
		return isInAlphabet(StringCodesUtil.getBytesUtf8(basen),true);
	}
